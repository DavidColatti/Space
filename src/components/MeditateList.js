	...
	for(let r=0; r<programsCopy.length; r++){
		if(programsCopy[r+3]){
			if(r % 4 ===0){
				rows.push(
					<MDBRow>
					<MDBCol md="3"><Card {...programsCopy[r]} /></MDBCol>
					<MDBCol md="3"><Card {...programsCopy[r+1]} /></MDBCol>
					<MDBCol md="3"><Card {...programsCopy[r+2]} /></MDBCol>
					<MDBCol md="3"><Card {...programsCopy[r+3]} /></MDBCol>
