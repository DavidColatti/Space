...
class MeditateDetails extends Component {
  ...
  getNarrators = () => { // NARRATOR FUNCTION- COLLECT HEADSHOT, NAME, AND TITLE
  ...
  getGuides = () => { // GUIDE FUNCTION- TITLE AND AUDIO 
  ...
  displayDetails = () => { // DISPLAY DETAIL FUNCTION- PROGRAM, TITLE, NARRATORS, GUIDES
